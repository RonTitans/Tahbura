-- מערכת מעקב בדיקות הנדסיות - נתוני בסיס
-- Hebrew Construction Site Inspection Tracking System - Basic Seed Data
-- 
-- This file contains basic reference data without user dependencies:
...
-- =============================================================================
-- BUILDINGS - מבנים (25 buildings from Excel, without manager_id)
-- =============================================================================
...
-- Technical buildings
('20', 'מבנה 20', 'Building 20', 'technical', 'קריית התקשוב, אזור תעשיה', 3, 'מבנה טכני 20', true),
('30', 'מבנה 30', 'Building 30', 'technical', 'קריית התקשוב, אזור תעשיה', 3, 'מבנה טכני 30', true),
('40', 'מבנה 40', 'Building 40', 'technical', 'קריית התקשוב, אזור תעשיה', 2, 'מבנה טכני 40', true),
('50', 'מבנה 50', 'Building 50', 'technical', 'קריית התקשוב, אזור תעשיה', 3, 'מבנה טכני 50', true),
('60', 'מבנה 60', 'Building 60', 'technical', 'קריית התקשוב, אזור תעשיה', 2, 'מבנה טכני 60', true),
('70', 'מבנה 70', 'Building 70', 'technical', 'קריית התקשוב, אזור תעשיה', 3, 'מבנה טכני 70', true),
('80', 'מבנה 80', 'Building 80', 'technical', 'קריית התקשוב, אזור תעשיה', 3, 'מבנה טכני 80', true),
('90', 'מבנה 90', 'Building 90', 'technical', 'קריית התקשוב, אזור תעשיה', 2, 'מבנה טכני 90', true),

-- Office and administrative buildings
('100', 'מבנה 100', 'Building 100', 'office', 'קריית התקשוב, אזור תעשיה', 5, 'מבנה משרדים 100', true),
('110', 'מבנה 110', 'Building 110', 'technical', 'קריית התקשוב, אזור תעשיה', 3, 'מבנה טכני 110', true),
('120', 'מבנה 120', 'Building 120', 'technical', 'קריית התקשוב, אזור תעשיה', 3, 'מבנה טכני 120', true),
('130', 'מבנה 130', 'Building 130', 'technical', 'קריית התקשוב, אזור תעשיה', 2, 'מבנה טכני 130', true),
('140', 'מבנה 140', 'Building 140', 'technical', 'קריית התקשוב, אזור תעשיה', 3, 'מבנה טכני 140', true),

-- Specialized buildings
('161', 'מבנה 161', 'Building 161', 'technical', 'קריית התקשוב, אזור תעשיה', 2, 'מבנה טכני מיוחד 161', true),
('162', 'מבנה 162', 'Building 162', 'technical', 'קריית התקשוב, אזור תעשיה', 2, 'מבנה טכני מיוחד 162', true),
('163', 'מבנה 163', 'Building 163', 'technical', 'קריית התקשוב, אזור תעשיה', 2, 'מבנה טכני מיוחד 163', true),
('164', 'מבנה 164', 'Building 164', 'technical', 'קריית התקשוב, אזור תעשיה', 2, 'מבנה טכני מיוחד 164', true),
('171', 'מבנה 171', 'Building 171', 'technical', 'קריית התקשוב, אזור תעשיה', 2, 'מבנה טכני מיוחד 171', true),
('172', 'מבנה 172', 'Building 172', 'technical', 'קריית התקשוב, אזור תעשיה', 2, 'מבנה טכני מיוחד 172', true),
